...
//import com.example.foodfoodapp.databinding.ResultRowLayoutBinding
...
//        val binding = ResultRowLayoutBinding.inflate(
...
//
//    inner class ViewHolder(private val binding: ResultRowLayoutBinding) :
//        RecyclerView.ViewHolder(binding.root) {
//
//        fun bind(label: String?, score: Float?) {
//            with(binding) {
//                labelButton.text = label ?: NO_VALUE
//                scoreTextView.text = if (score != null) String.format("%.2f", score) else NO_VALUE
//            }
//        }
//    }
//}
