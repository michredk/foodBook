...
import com.example.spoonacularapp.util.Constants.Companion.QUERY_TYPE
...
class RecipesViewModel @Inject constructor(
    ...
    fun saveMealAndDietType(mealType: String, mealTypreId: Int, dietType: String, dietTypeId: Int) =
        viewModelScope.launch(Dispatchers.IO) {
            dataStoreRepository.saveMealAndDietType(mealType, mealTypreId, dietType, dietTypeId)
        }
